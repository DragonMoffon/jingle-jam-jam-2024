# sourced from https://github.com/HakanSeven12/Delaunator-Python/blob/master/Delaunator.py
# I couldn't find it on pypi so I copied it and made it a little more pythony
